...
# --- 1. Validating support for GL-MT5000 ---------
echo ">> Verifying GL-MT5000 device support (PR #24237)"
test -f target/linux/mediatek/dts/mt7987a-gl-mt5000.dts || { echo ">> ERROR: DTS missing in PR"; exit 1; }
grep -q "glinet_gl-mt5000" "$FILOGIC_MK" || { echo ">> ERROR: device recipe missing in PR"; exit 1; }
echo ">> Device support verified"
